...
const Header = () => {
	...
	return (
		<>
			...
			>
				{/* Desktop */}
				<div className='hidden slg:grid grid-cols-4 items-center w-full py-2.5 max-w-[1300px] z-30 px-5 lg:px-2 xl:px-0'>
						...
						<div className='flex items-center gap-2'>
							<Dropdown placement='bottom-end'>
								<DropdownTrigger>
									<button
										type='button'
										className='flex items-center gap-1 px-3 py-1 bg-white border border-transparent hover:border-gray-200 rounded hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primaryColor-400'
								...
								<DropdownMenu
									...
									className='min-w-[200px] p-2 shadow-lg rounded border border-gray-100 bg-white'
							...
							>
								{typeof window !== "undefined" && (
									<div className='flex relative justify-center items-center rounded-full w-12 h-12 p-2 text-sm'>
										...
										<BsCart4 className='text-3xl text-primaryColor-400' />
									</div>
								)}
